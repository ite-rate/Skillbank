...
description: End-to-end research paper writing and revision pipeline for scientific manuscripts, including experiment design, execution monitoring, statistical analysis, title/abstract/introduction repair, figure/table quality, citation workflow, self-review, and submission readiness. Use when Codex needs to write, audit, revise, or polish research papers for ML/AI or related venues such as NeurIPS/ICML/ICLR/ACL/AAAI/COLM and applied journals.
level: manual
