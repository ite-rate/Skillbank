 ...
 *   node render_cover.js --input cover.html --output cover.pdf --wait 1200
 *
...
function usage() {
  console.error("Usage: node render_cover.js --input <file.html> --out|--output <file.pdf> [--wait <ms>]");
  process.exit(1);
}
...
for (let i = 0; i < args.length; i++) {
  ...
  else if ((args[i] === "--out" || args[i] === "--output") && args[i + 1]) { outFile = args[++i]; }
