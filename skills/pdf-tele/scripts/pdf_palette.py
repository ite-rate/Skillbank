...
Usage:
    ...
    python3 palette.py --title "增长报告" --subtitle "全渠道增长与AI赋能" --type report --out tokens.json
...
def build_tokens(
    ...
    Args:
        ...
        author:            Author name (defaults to TeleAgent).
        date:              Date string (optional).
        subtitle:          Cover subtitle/deck string (optional).
    ...
    # Detect CJK in title, subtitle, author, or body text sample.
    ...
    is_cjk = _has_cjk(title + " " + subtitle + " " + author + " " + content_text)
...
def main():
    ...
    parser.add_argument("--author", default="TeleAgent")
    parser.add_argument("--date",   default="")
    parser.add_argument("--subtitle", default="", help="Optional cover subtitle/deck")
    parser.add_argument("--meta",     help="JSON file with title/type/author/date/subtitle keys")
    ...
    parser.add_argument("--out", "--output", dest="out", default="tokens.json")
    ...
    if args.meta:
        try:
            ...
            args.author = meta.get("author") or args.author
            args.date   = meta.get("date",   args.date)
            args.subtitle = meta.get("subtitle", args.subtitle)
