...
class base_schema_validator_impl:
    """Base validator with common validation logic for document files."""
    ...
    def validate_namespaces_impl(self):
    ...
    def validate_unique_ids_impl(self):
    ...
    def validate_file_references_impl(self):
        """
    ...
    def validate_all_relationship_ids_impl(self):
        """
    ...
    def validate_content_types_impl(self):
    ...
    def validate_file_against_xsd_impl(self, xml_file, verbose=False):
    ...
    def validate_against_xsd_impl(self):
        ...
        for xml_file in self.xml_files:
            ...
            is_valid, new_file_errors = self.validate_file_against_xsd_impl(
