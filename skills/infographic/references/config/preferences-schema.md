...
preferred_style: null     # any of the 22 styles (see Style Gallery in SKILL.md) or null
...
custom_styles:            # extra style definitions merged with the 22 built-ins
  - name: my-brand
...
| `custom_styles` | array | [] | Additional styles available alongside the 22 built-ins |
...
See the **Style Gallery (22)** table in `SKILL.md` for the canonical list. Common picks:
