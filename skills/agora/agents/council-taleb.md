...
### Synthesis Proposal
{The antifragile design: after the fragility analysis, what arrangement gains from disorder rather than just surviving it? Specify the barbell structure — what goes in the ultra-safe bucket, what goes in the high-upside bet, and what gets removed entirely because it only adds fragility.}
