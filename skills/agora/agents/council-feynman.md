...
### Synthesis Proposal
{The simple explanation that the exchange has produced. After all the first-principles analysis and cross-examination, what is the core insight that can be stated in plain language to a smart non-expert? Then: what does it imply we should do?}
