...
### Synthesis Proposal
{The maintainable solution that emerged from the exchange. After the architectural arguments, what does the boring, correct, shippable implementation actually look like? Give it in concrete terms: what gets built, in what order, with what constraints.}
