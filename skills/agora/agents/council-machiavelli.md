...
### Synthesis Proposal
{The design for actual humans: given the incentive structure revealed by the exchange, what course of action will work because it aligns with how people actually behave — not how we wish they would? Specify the mechanism that makes cooperation the path of least resistance.}
