...
### Synthesis Proposal
{The empirically grounded path that integrates both perspectives: what does the actual training data and observed model behavior tell us? State the specific approach — whether ML or not — that the evidence supports, with concrete implementation guidance and the failure modes to monitor.}
