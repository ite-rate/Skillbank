...
### Synthesis Proposal
{The intervention at the highest available leverage point: after mapping the feedback structure revealed by both thesis and antithesis, where is the node that shifts the system with minimum force? Specify the intervention level (parameter, feedback loop, rule, goal, or paradigm) and explain why this level is both achievable and transformative.}
